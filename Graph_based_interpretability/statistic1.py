...
if not os.path.exists('/home/dell/mxq/toxic_mol/model/MS2/Graph_based_interpretability/data/rat/img_1'):
    os.makedirs('/home/dell/mxq/toxic_mol/model/MS2/Graph_based_interpretability/data/rat/img_1')
...
# Read CSV file
df = pd.read_csv('/home/dell/mxq/toxic_mol/model/MS2/Graph_based_interpretability/data/rat/'+'toxic.csv')
...
def predict_and_calculate_shapley(model, device, loader, target_class=0):
    ...
    with torch.no_grad():
        for idx, data in enumerate(loader):
            ...
            img_path = os.path.join('/home/dell/mxq/toxic_mol/model/MS2/Graph_based_interpretability/data/rat/img_1', f'{safe_smiles}.png')
            print(img_path)
            img.save(img_path)
...
processed_test = '/home/dell/mxq/toxic_mol/model/MS2/Graph_based_interpretability/data/rat/toxic.pth'
if not os.path.isfile(processed_test):
    ...
    model_file_name = '/home/dell/mxq/toxic_mol/model/MS2/Graph_based_interpretability/data/rat/model_Rat_5_5.pt'
